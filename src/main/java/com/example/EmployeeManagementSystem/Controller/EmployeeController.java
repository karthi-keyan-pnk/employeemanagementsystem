...
public class EmployeeController {
    ...
    @PostMapping("/addEmp")
    public ResponseEntity<ResponseDTO> addEmployee(@Validated @NotNull @RequestBody RequestDTO requestDTO){
        return new ResponseEntity<>(employeeService.addEmployee(requestDTO),HttpStatus.CREATED);
    }

    @DeleteMapping("/delEmp")
    public ResponseEntity<String> deleteEmployee (@Validated @NotNull @PathVariable Long id) {
        employeeService.deleteEmployee(id);
        return new ResponseEntity<>("Employee Deleted",HttpStatus.OK);
    }

    @PutMapping("/uptEmp")
    public ResponseEntity<ResponseDTO> updateEmployee(@PathVariable Long id, @Validated @NotNull  @RequestBody RequestDTO requestDTO){
